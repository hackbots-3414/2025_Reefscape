...
public class RobotContainer {
    ...
    private void configureSysId() {
        ...
        SmartDashboard.putData("SysID DTF", drivetrain.sysIdDynamicTranslation(Direction.kForward));
        SmartDashboard.putData("SysID DRF", drivetrain.sysIdDynamicRotation(Direction.kForward));
        SmartDashboard.putData("SysID DSF", drivetrain.sysIdDynamicSteer(Direction.kForward));
        SmartDashboard.putData("SysID QRF", drivetrain.sysIdQuasistaticRotation(Direction.kForward));
        SmartDashboard.putData("SysID QSF", drivetrain.sysIdQuasistaticSteer(Direction.kForward));
        SmartDashboard.putData("SysID QTF", drivetrain.sysIdQuasistaticTranslation(Direction.kForward));

        SmartDashboard.putData("SysID DTR", drivetrain.sysIdDynamicTranslation(Direction.kReverse));
        SmartDashboard.putData("SysID DRR", drivetrain.sysIdDynamicRotation(Direction.kReverse));
        SmartDashboard.putData("SysID DSR", drivetrain.sysIdDynamicSteer(Direction.kReverse));
        SmartDashboard.putData("SysID QRR", drivetrain.sysIdQuasistaticRotation(Direction.kReverse));
        SmartDashboard.putData("SysID QSR", drivetrain.sysIdQuasistaticSteer(Direction.kReverse));
        SmartDashboard.putData("SysID QTR", drivetrain.sysIdQuasistaticTranslation(Direction.kReverse));
    }
