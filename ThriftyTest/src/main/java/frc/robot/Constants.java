...
public class Constants {
    ...
    public static final class ElevatorConstants {
        ...
        public static enum ElevatorPosition {
            ...
            L2(Units.inchesToMeters(35.5) * metersToRotations),
            L3(Units.inchesToMeters(50.5) * metersToRotations),
            L4(Units.inchesToMeters(76.0) * metersToRotations),
            Net(Units.inchesToMeters(79.0) * metersToRotations),
            Stow(Units.inchesToMeters(2.45) * metersToRotations),
            ReefHigh(Units.inchesToMeters(31.89) * metersToRotations),
            ReefLow(Units.inchesToMeters(14.17) * metersToRotations),
            Processor(Units.inchesToMeters(0.886) * metersToRotations),
            Ground(0.0);
            ...
            public static ElevatorPosition fromAlgaePreset(
                ...
                switch (preset) {
                    case REEFUPPER -> position = ElevatorPosition.ReefHigh;
                    case REEFLOWER -> position = ElevatorPosition.ReefLow;
                    case PROCESSOR -> position = ElevatorPosition.Processor;
                    case NET -> position = ElevatorPosition.Net;
                    case GROUND -> position = ElevatorPosition.Ground;
                }
                return position;
            }
