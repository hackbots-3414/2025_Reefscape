...
public class Constants {
  ...
  public static final class ElevatorConstants {
    ...
    /*
     * Please note: The maximum height of the elevator (in inches) was calculated to be 80.44
     * inches. Accounting for e rror, we really never should set a setpoint higher than 79 inches
     * (how we chose the net height)
     */
    ...
    public static final double unsafeRange = ElevatorState.L2.position() + 2 * inch;
  ...
  public enum ScoringLocations {
    ...
    RIGHTHP(new Pose2d(1.227, 1.048, Rotation2d.fromDegrees(55))), LEFTHP(
        new Pose2d(1.227, 6.983, Rotation2d.fromDegrees(-55))), PROCESSOR(
            new Pose2d(6.0, 0.6, Rotation2d.fromDegrees(-90))), NET(
                new Pose2d(7.7, 6.0, Rotation2d.fromDegrees(0)));
