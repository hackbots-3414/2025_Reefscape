...
public class AutonomousUtil {
    ...
    public static void queuePathWithCommand(Pose2d pose, Supplier<Command> command) {
        try {
            ...
            onTheFlyCommands.add(new PathPlannerOverride(FieldUtils.getAlliancePose(RobotObserver.getPose())));
    ...
    public static Pose2d clip(List<Pose2d> list) {
        return FieldUtils.getAlliancePose(RobotObserver.getPose()).nearest(list);
    }
