...
public class TestBotTunerConstants {
    // Both sets of gains need to be tuned to your individual robot.

    // The steer motor uses any SwerveModule.SteerRequestType control request with the
    // output type specified by SwerveModuleConstants.SteerMotorClosedLoopOutput
    private static final Slot0Configs steerGains = new Slot0Configs()
        .withKP(54.2).withKI(0).withKD(0)
        .withKS(0.0938).withKV(3.04).withKA(0.147)
        .withStaticFeedforwardSign(StaticFeedforwardSignValue.UseClosedLoopSign);
    // When using closed-loop control, the drive motor uses the control
    // output type specified by SwerveModuleConstants.DriveMotorClosedLoopOutput
    private static final Slot0Configs driveGains = new Slot0Configs()
        .withKP(0.152).withKI(0).withKD(0)
        .withKS(0.175).withKV(0.121).withKA(0.005);
    ...
    private static final Angle kFrontLeftEncoderOffset = Rotations.of(0.310791015625);
    ...
    private static final Angle kFrontRightEncoderOffset = Rotations.of(-0.437744140625);
    ...
    private static final Angle kBackRightEncoderOffset = Rotations.of(-0.14599609375);
